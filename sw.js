const CACHE="vizag-rise-v3";
const CORE=["./","./index.html","./manifest.webmanifest","./css/main.css","./css/menu.css","./css/hud.css","./css/map.css","./js/main.js","./js/core/ReleaseManager.js"];
